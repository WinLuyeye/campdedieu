  ...
  <footer className="bg-[#08367a] text-white">
    ...
    <div className="max-w-7xl mx-auto px-6 py-10 flex justify-between gap-10 flex-wrap">
      ...
      >
        ...
        <ul className="space-y-6 text-base lg:text-base font-medium">
          ...
          <li className="flex items-center gap-2">
            ...
            <a href="tel:+243999999999" className="hover:text-[#980d0e] transition-colors">
              +243 999 999 999
            </a>
          </li>
          <li className="flex items-center gap-2">
            <FaEnvelope className="flex-shrink-0" />
            <a href="mailto:contact@kerithressourcesdrc.com" className="hover:text-[#980d0e] transition-colors">
      ...
      >
        ...
        <ul className="space-y-2 text-base lg:text-base font-medium">
          {navLinks.map((link) => (
            <li key={link.name}>
              <Link href={link.href} className="hover:text-[#980d0e] transition-colors">
                {link.name}
              </Link>
            </li>
          ))}
      ...
      >
        ...
        <ul className="space-y-2 text-base lg:text-base font-medium">
          <li>
            <Link href="/news" className="hover:text-[#980d0e] transition-colors">
              Actualités
            </Link>
          </li>
          <li>
            <Link href="/gallery" className="hover:text-[#980d0e] transition-colors">
              Galerie
            </Link>
          </li>
          <li>
            <Link href="/faq" className="hover:text-[#980d0e] transition-colors">
              FAQ
            </Link>
          </li>
        </ul>
    ...
    >
      ...
      <div className="mt-2 flex flex-wrap justify-center gap-x-4 gap-y-2">
        <Link href="/#" className="hover:text-[#980d0e] transition-colors text-xs">
          Confidentialité
        </Link>
