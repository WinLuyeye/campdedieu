      ...
      <section className="relative max-w-7xl mx-auto px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <p className="text-xl font-medium mb-6 max-w-lg mt-4 z-10 relative">
            vous pouvez nous contacter pour toute demande d&lsquo;information, de partenariat ou de prière. Nous sommes là pour vous aider et vous soutenir dans votre cheminement spirituel.
          </p>
